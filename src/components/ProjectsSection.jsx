import { ArrowRight, Construction, ExternalLink, Github } from "lucide-react";
      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {projects.map((project, key) => (
            <a
              key={key}
              className="group bg-card rounded-large overflow-hidden shadow-xs card-hover w-full flex flex-col"
            ...
            >
              ...
              <div className="p-6 flex flex-col flex-1">
                ...
                {project.underConstruction && (
                  <div className="flex items-center justify-center gap-1.5 text-xs text-yellow-500/80 mb-4">
                    <Construction size={13} />
                    <span>Under construction — not yet hosted</span>
                  </div>
                )}
